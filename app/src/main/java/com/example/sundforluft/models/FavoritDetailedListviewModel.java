...
public class FavoritDetailedListviewModel {

    private String name, procent;
    private int currentAir;
    private final Fragment fragment;

    public FavoritDetailedListviewModel(Fragment fragment, String name, String procent, int currentAir) {
